...
#define startTimeout() (dev->g_timeoutStartMs = HAL_GetTick())

// Check if timeout is enabled (set to nonzero value) and has expired
#define checkTimeoutExpired() (dev->g_ioTimeout > 0 && ((uint16_t)HAL_GetTick() - dev->g_timeoutStartMs) > dev->g_ioTimeout)
...
uint8_t initVL53L0X(VL53L0X *dev, bool io_2v8, I2C_HandleTypeDef *handler);
...
uint8_t setSignalRateLimit(VL53L0X *dev, float limit_Mcps);
...
uint8_t setMeasurementTimingBudget(VL53L0X *dev, uint32_t budget_us);
...
uint8_t setVcselPulsePeriod(VL53L0X *dev, vcselPeriodType type, uint8_t period_pclks);
...
//---------------------------------------------------------
void writeReg(VL53L0X *dev, uint8_t reg, uint8_t value);        // Write an 8-bit register
void writeReg16Bit(VL53L0X *dev, uint8_t reg, uint16_t value);  // Write a 16-bit register
void writeReg32Bit(VL53L0X *dev, uint8_t reg, uint32_t value);  // Write a 32-bit register
uint8_t readReg(VL53L0X *dev, uint8_t reg);                     // Read an 8-bit register
uint16_t readReg16Bit(VL53L0X *dev, uint8_t reg);               // Read a 16-bit register
uint32_t readReg32Bit(VL53L0X *dev, uint8_t reg);               // Read a 32-bit register
